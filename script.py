...
def loopThroughInputList():
	...
	while il < len(MARC773s):
		...
		#endeca_url = "http://search.lib.unc.edu/search?Nf=PubDateSort|BTWN%202014%202015&action=or:206605,false&Nty=1&output-format=xml&facet-options=exclude-refinements&include-record-property=ICE+Chapter+Title&include-record-property=Syndetics+ISBN&include-record-property=OCLCNumber&include-record-property=UPC&include-record-property=Main+Author&include-record-property=Other+Authors&maximum-number-records=1000&record-options=include-record-facets&include-record-property=Format" #UPC TEST URL
